...
class ETLMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.operation_buttons: Dict[str, QWidget] = {}

        # UI builder and operation handler
        self._ui_builder = AdminUIBuilder(self)
    ...
    def _clean_application_cache(self):
        ...
        try:
            ...
            cleaner.clean_all(verbose=False, clean_logs=False)
    ...
    def _setup_ui(self):
        ...
        # Toolbar
        toolbar = self._ui_builder.create_toolbar()
        ...
        splitter = self._ui_builder.create_main_layout()
    ...
    def _save_settings(self):
        ...
        self._settings.setValue("api_url", self._api_url_input.text())
